...
const CONFIG = {
  ...
  SERVER_URL: 'wss://pixel-planes.onrender.com',
  ...
  BH_HORIZON: 390,     // event-horizon radius -- cross it and you're crushed.
  BH_DISK_R: 1380,     // size of the glowing accretion disk (looks only).
  ...
  // With the ∞ Missiles cheat, HOLDING X rapid-fires this many missiles per
  // frame (5 x 60fps = ~300 missiles/second!). Capped so it can't freeze.
  INF_MISSILE_RATE: 5,
